...
from framework.locators.triggers import TriggerTemplateYamlPageLocators
...
from framework.ui_components.console_url_patterns import TRIGGERTEMPLATE_YAML_URL


class TriggerTemplateYamlPage(BasePage):
    """Page object for the TriggerTemplate YAML editor tab."""

    def __init__(self, page: Page, config: Config) -> None:
        super().__init__(page, config)
        self.locators = TriggerTemplateYamlPageLocators()
    ...
    async def verify_on_page(self) -> bool:
        """
        Verifies that the TriggerTemplate YAML tab is currently displayed by checking URL and
        ...
        return await self._verify_page_regex(
            TRIGGERTEMPLATE_YAML_URL, self.locators.YAML_EDITOR, "TriggerTemplate YAML page"
        )
    ...
    async def click_toggle_sidebar(self) -> bool:
        """
        Clicks the 'Show/Hide sidebar' toolbar button to toggle the schema sidebar.
        :return: bool: True if click succeeds.
        """
    ...
    async def click_save(self) -> bool:
        """
        Clicks the 'Save' button to save changes to the TriggerTemplate YAML.
        :return: bool: True if click succeeds.
        """
    ...
    async def click_reload(self) -> bool:
        """
        Clicks the 'Reload' button to discard changes and reload the original YAML.
        :return: bool: True if click succeeds.
        """
